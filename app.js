     ...
     if(err){
      res.send('db error');
       ...
       if(doc.length>0){
         ...
         placenameru : 'Тестхостел',
         placenameen : 'Testhostel',
         founddateint:20140305,
         founddate:{day:'05',month:'02',year:'2014'},
         regdate:{day:vday,month:vmonth,year:vyear},
         adressru: 'Какаятосраная наб. дом 10 к.3 кв. 12',
         adressen: 'Somefucking emb. 10 bld.3 flat 12',
         contacts:{phone:'+7XXXXXXXXXX',www:'http://recentones.com/bobo'},
         pid: newid,
         pano:1,
         mainpreview:'/bootstrap/images/sample2.jpg',
         xml:'/bootstrap/images/emptypano.xml'
         });
         res.redirect('http://recentones.com/admin/placelist');
         console.log('PLACE SIMULATED');
...
app.post('/admin/simulateemptyplacewithdate',function(req,res){
   ...
   console.log(req.body.foundmonth);
   console.log(req.body.foundyear);
   console.log(req.body.regday);
   console.log(req.body.regmonth);
   console.log(req.body.regyear);
     ...
     if(err){
      res.send('db error');
       ...
       if(doc.length>0){
         ...
         founddate:{day:vfoundday,month:vfoundmonth,year:vfoundyear},
